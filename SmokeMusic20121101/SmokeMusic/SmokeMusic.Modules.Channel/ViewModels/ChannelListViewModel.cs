...
namespace SmokeMusic.Modules.Channel.ViewModels
{
    public class ChannelListViewModel : ViewModelBase
    {
        ...
        {
            this.PersonalChannelList = new ObservableCollection<Logic.Models.Channel>();
            this.PublicChannelList = new ObservableCollection<Logic.Models.Channel>();
            this.DJChannelList = new ObservableCollection<Logic.Models.Channel>();
            if (!IsInDesignMode)
            {
        ...
        /// 所有频道
        /// </summary>
        public Logic.Models.ChannelList AllChannel { get; private set; }        
        /// <summary>
        /// 私人频道列表
        /// </summary>
        public ObservableCollection<Logic.Models.Channel> PersonalChannelList { get; private set; }
        /// <summary>
        /// 公共频道列表
        /// </summary>
        public ObservableCollection<Logic.Models.Channel> PublicChannelList { get; private set; }
        /// <summary>
        /// DJ频道列表
        /// </summary>
        public ObservableCollection<Logic.Models.Channel> DJChannelList { get; private set; }
        /// <summary>
        /// 重写Title,用于注册Region
        /// </summary>
        ...
        public void OnChooseSearchResult(Logic.Models.SearchResult result)
        {
            ...
            var channel = new Logic.Models.Channel() { ID = 0, Name = result.Title, Context = result.Context };
